    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{url('home')}}" class="logo">
          ...
          <span class="logo-lg"><b>Tenant</b>MS</span>
        </a>
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="active"><a href="{{url('warehouse/create')}}"><i class="fa fa-pencil-square-o"></i> Input Items</a></li>
                <li><a href="{{url('warehouse/listi')}}"><i class="fa fa-table"></i> Status Items</a></li>
              </ul>
            </li>
            <li class="treeview">
              <a href="#">
                <i class="fa fa-archive"></i><span>Packages</span><i class="fa fa-angle-left pull-right"></i>
              </a>
              <ul class="treeview-menu">
              <li class="active"><a href="{{url('warehouse/package')}}"><i class="fa  fa-pencil-square-o"></i> <span>Input Packages</span></li>
              </a>
              <li><a href=" {{url('warehouse/listp')}}"><i class="fa fa-table"></i>Status Package</a></li>
              </ul>
            </li>            
            <!-- <li class="treeview">
              <a href="{{url('gps')}}">
   ...
   <script>
      $(function () {
        $("#btn-add").on('click',function() {
          var count_add = parseInt($('.count_item').val());
          if (count_add >= 15) {
            alert('Form cannot be added');
        }
        else{
          $('.count_item').val(count_add+1);
          $('#form-group-'+count_add).after('<div class="form-group" id="form-group-'+$('.count_item').val()+'"><div class="col-sm-10"><label>Item Name :</label><input class="form-control" placeholder="Company Name :" name="name-'+$('.count_item').val()+'" id="name-'+$('.count_item').val()+'" data-success="complete" required=""></div><div class="col-sm-2"><label>Stock :</label><input class="form-control" placeholder=" Pcs" name="stock-'+$('.count_item').val()+'"></div></div>');            
